...
public class Ants {
    ...
    public Ants(int loadTime, int turnTime, int rows, int cols, int turns, int viewRadius2,
            int attackRadius2, int spawnRadius2, Tile[][] mapTiles) {
    ...
    public List<Aim> getDirections(Tile t1, Tile t2) {
		...
		// the original function to find the direction is still working when these two tiles are near
